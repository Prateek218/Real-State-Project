...
<form name="f1" method="get" action="news_reg.jsp" style="text-align:left">
<br />
<br />
...
<td> 
 <input onClick="ds_sh(this);" name="t1" readonly="readonly" style="cursor: text" /><br />
</td>
</tr>
...
<label> News :</label></td>
<td> <textarea name="t3" cols="30" rows="20">
</textarea>
</td></tr>
...
<tr>
<td><label> Choose Picture:</label></td><td> <input type="file" name="t4"   accept="image/gif,image/jpeg" /></td>
