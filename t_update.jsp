...
session.setAttribute("username",session.getAttribute("username"));
 ...
 Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	...
	ResultSet rs=stmt.executeQuery("Select * from ten_master where name='"+uname+"'");
%>

<div id="main_column" style="width:530px">


<center><h2>SELECT ROWS TO UPDATE!!</h2></center>
<form name="f1" action="update_t.jsp">
